...
class _MySceneState extends State<MyScene> with RouteAware{
    ...
    return Scaffold(
      body: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              _buildHeader(),
              _buildItem('images/icon_github.png', 'Apollo官网', _openGithub),
              _buildItem('images/icon_wechat.png', '我的钱包', _copyWechatNumber),
            ],
          )),
    );
  }
  ...
  _openGithub() {
    AppNavigator.push(context, WebViewScene(url: 'http://www.apollovideo.io/',title: 'Apollo',));
  }
  ...
  _copyWechatNumber() {
    Clipboard.setData(ClipboardData(text:'ApolloVideo'));
    Toast.show('已复制微信号');
  }
  ...
  Widget _buildHeader() {
    ...
    return Container(
      ...
      child: Stack(
        children: <Widget>[
          Image(
            image: AssetImage('images/apollo.png'),
            fit: BoxFit.cover,
            width: Screen.width,
            height: height,
          ),
          ...
          BackdropFilter(
            ...
            child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      backgroundImage: AssetImage('images/apollo.png'),
                      radius: 50.0,
                    ),
                    SizedBox(
                      height: 10,
