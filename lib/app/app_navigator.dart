...
import 'package:movie_recommend/community/video_detail/video_detail_view.dart';
...
class AppNavigator {
  ...
  //进入视频列表
  static pushVideoList(BuildContext context, String title, String action){
    AppNavigator.push(context, VideoListView(title: title, action: action));
  }
  //进入视频详情
  static pushVideoDetail(BuildContext context, VideoItem video){
    AppNavigator.push(context, VideoDetailView(id: video.id));
  }
